...
public class MedianFilter implements Filter {
    ...
    public void compute(double[] sourceData,
        ...
        /*org.esa.beam.fronts.FrontsOperator.makeFilledBand(preparedData, sourceWidth, sourceHeight,
                targetBandFilter, org.esa.beam.fronts.FrontsOperator.maxKernelRadius);*/
